This repo is to practice git. Everyone has READ ONLY access 
in the MAIN branch. I and Beka will have direct access to MAIN. 
We will be sharing files in MAIN (mainly homework and maybe python).
If you want to make changes in MAIN branch or add files to the MAIN branch, 
you need to issue a Pull Request.

Some rules:
    1. Nobody cannot push to MAIN branch directly (only me and Beka)
